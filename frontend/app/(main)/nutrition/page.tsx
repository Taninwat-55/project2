        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          <div className="lg:col-span-2 bg-zinc-900/40 p-8 rounded-[2.5rem] border border-zinc-800/50">
            ...
            <div className="space-y-4">
              {[
                { icon: "🥐", name: "Breakfast", desc: "Oatmeal & Berries • 450 kcal" },
                { icon: "🍲", name: "Lunch", desc: "Recommended: 600 - 800 kcal" },
                { icon: "🥗", name: "Dinner", desc: "Recommended: 500 - 700 kcal" },
                { icon: "🍎", name: "Snack", desc: "270 kcal • Green Smoothie" },
              ].map((meal) => (
                <div key={meal.name} className="flex justify-between items-center p-5 bg-black/40 rounded-2xl border border-zinc-800 hover:bg-zinc-800/40 transition group">
