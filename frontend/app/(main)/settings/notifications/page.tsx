...
import { getUserSettings, updateNotificationSettings } from "@/app/actions/settings";
...
export default function NotificationsPage() {
    ...
    useEffect(() => {
        const load = async () => {
            ...
            setPauseAll(settings.pause_all_notifications);
            setDailyReminders(settings.daily_reminders);
            setGoalCompletions(settings.goal_completions);
            setWeeklyReport(settings.weekly_report);
            setFriendRequests(settings.friend_requests);
            setChallengeInvites(settings.challenge_invites);
            setComments(settings.comments_mentions);
            setKudos(settings.kudos);
    ...
    const handleSave = async () => {
        ...
        const result = await updateNotificationSettings({
            pause_all_notifications: pauseAll,
                ...
                <div className="flex gap-8">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="mb-8 pb-6 border-b border-[var(--border)]">
                            ...
                            <p className="text-[var(--muted-foreground)] text-sm">Manage how and when you receive updates about your fitness journey.</p>
                        </div>

                        {/* Pause All Notifications */}
                        <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-5 mb-8 flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-[var(--muted-foreground)]">Temporary silence all push and email notifications.</p>
                                </div>
                            </div>
                                ...
                                <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-5 flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-[var(--muted-foreground)]">Receive an email notification to start your daily routine.</p>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-5 flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-[var(--muted-foreground)]">Get celebrated when you hit your milestones.</p>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-5 flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-[var(--muted-foreground)]">Summary of your stats delivered via email.</p>
                                        </div>
                                    </div>
