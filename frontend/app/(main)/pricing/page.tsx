...
export default function PricingPage() {
  ...
  return (
    <>
      {/* SiteHeader removed - inherited from layout */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-orange-600/10 border border-orange-600/20 rounded-3xl p-8 mb-20 flex flex-col md:flex-row items-center justify-between gap-8 transition-all hover:bg-orange-600/15">
            ...
            <button
              ...
              className={`px-8 py-4 rounded-xl font-bold transition-all whitespace-nowrap flex items-center gap-2 ${blueprintSent ? 'bg-green-600 text-white' : 'bg-orange-600 hover:bg-orange-700 text-white'
                }`}
            >
              {blueprintSent ? (
